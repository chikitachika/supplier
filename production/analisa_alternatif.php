          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-book"></i> Analisa Alternatif </h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Analisa Alternatif</h2>
                  ...
                  ?>
                    ...
                    <td align="center">
                      <a href="analisa_alternatif_hapus.php?id_alternatif=<?php echo $row['id_alternatif'] ?>" onclick="return confirm('Yakin ingin menghapus data?')"><i class="fa fa-trash"></i> </a>
                    </td>
                  </tr>
                  <?php
                  $no++;
