...
<?php
      ...
      // menghitung jumlah data pada table alternatif untuk menentukan RC
			$data = mysqli_query($koneksi, "SELECT * FROM tb_alternatif ORDER BY id_data");
			$jml_data = mysqli_num_rows($data); //menentukan jumlah data yg ada pada tabel tabel_alternatif
			if ($jml_data==1) {
				$rc = 0.00;
			}elseif ($jml_data==2) {
				$rc = 0.00;
